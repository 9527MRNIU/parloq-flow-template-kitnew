...
```bash
node packages/cli/src/index.mjs template validate themes/short-tagline-demo
npm run sync:components
node packages/cli/src/index.mjs template pack themes/short-tagline-demo --out themes/short-tagline-demo.zip
npm run build
