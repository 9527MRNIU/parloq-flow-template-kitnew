...
`::part()` selectors in `assets/theme.css`. The repository build compiles the
shared component source into `assets/account-link-elements.js` inside this
template's ZIP.
...
`0001-white-label-account-link-1.6.0.zip`. Sequence `0001` is permanent; the
