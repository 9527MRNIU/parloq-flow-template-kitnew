...
test("template source catalog preserves permanent template sequences", async () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      { sequence: "0002", source: "examples/myloveday-demo" },
      { sequence: "0003", source: "examples/short-tagline-demo" },
      { sequence: "0004", source: "examples/myloveday-showcase-demo" },
      { sequence: "0005", source: "examples/short-tagline-showcase-demo" },
      { sequence: "0006", source: "examples/myloveday-hotdates-demo" },
    ],
  );
