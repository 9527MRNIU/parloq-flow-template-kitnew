...
```bash
node packages/cli/src/index.mjs integration validate integrations/promotion-integration-script-demo
node packages/cli/src/index.mjs integration pack integrations/promotion-integration-script-demo
```
