...
;
  ...
  sbx0_offsets_22H = {
   ...
   "iPhone11,2_4_6_22H20": {
      GPUConnectionToWebProcess_CreateGraphicsContextGL: 0x29n,
      GPUConnectionToWebProcess_CreateRenderingBackend: 0x2bn,
      InitializeConnection: 0xbdan,
      ProcessOutOfStreamMessage: 0xbdcn,
      RemoteDisplayListRecorder_DrawGlyphs: 0x3cbn,
      RemoteDisplayListRecorder_FillRect: 0x3e0n,
      RemoteDisplayListRecorder_SetCTM: 0x3ebn,
      RemoteDisplayListRecorder_StrokeRect: 0x3ffn,
      RemoteGraphicsContextGLProxy_WasCreated: 0x409n,
      RemoteGraphicsContextGL_AttachShader: 0x40dn,
      RemoteGraphicsContextGL_BindBuffer: 0x412n,
      RemoteGraphicsContextGL_BindTexture: 0x418n,
      RemoteGraphicsContextGL_BufferData0: 0x425n,
      RemoteGraphicsContextGL_BufferData1: 0x426n,
      RemoteGraphicsContextGL_BufferSubData: 0x427n,
      RemoteGraphicsContextGL_CompileShader: 0x433n,
      RemoteGraphicsContextGL_CreateBuffer: 0x440n,
      RemoteGraphicsContextGL_CreateProgram: 0x442n,
      RemoteGraphicsContextGL_CreateShader: 0x447n,
      RemoteGraphicsContextGL_CreateTexture: 0x448n,
      RemoteGraphicsContextGL_Finish: 0x470n,
      RemoteGraphicsContextGL_Flush: 0x471n,
      RemoteGraphicsContextGL_GetBufferSubDataInline: 0xf0fn,
      RemoteGraphicsContextGL_GetShaderSource: 0xf27n,
      RemoteGraphicsContextGL_LinkProgram: 0x47bn,
      RemoteGraphicsContextGL_PixelStorei: 0x483n,
      RemoteGraphicsContextGL_Reshape: 0x48en,
      RemoteGraphicsContextGL_ShaderSource: 0x497n,
      RemoteGraphicsContextGL_TexImage2D1: 0x4a0n,
      RemoteGraphicsContextGL_UseProgram: 0x4cen,
      RemoteGraphicsContextGL_VertexAttrib4f: 0x4d6n,
      RemoteImageBufferProxy_DidCreateBackend: 0x4e1n,
      RemoteImageBuffer_PutPixelBuffer: 0x4e7n,
      RemoteRenderingBackendProxy_DidInitialize: 0x5a5n,
      RemoteRenderingBackend_CacheFont: 0x5a9n,
      RemoteRenderingBackend_CreateImageBuffer: 0x5adn,
      RemoteRenderingBackend_ReleaseImageBuffer: 0x5bdn,
      RemoteRenderingBackend_ReleaseRenderingResource: 0x5c2n,
      SyncMessageReply: 0xbden,
      WebProcessProxy_GPUProcessConnectionDidBecomeUnresponsive: 0xacbn,
   },
  ...
  sbx0_offsets = Object.assign({}, sbx0_offsets_22H);
  ...
  (function SBX0() {
    ...
    secondaryConnection.createReceivePort();
    {
      ...
      try {
        ...
        const sbx1_script = getJS('sbx1/sbx1_18.7.js');
        eval(sbx1_script);
